...
(function () {
    ...
    function updateLogoRotation(scrollY) {
        if (!mainLogo) return;
        var scrollableDist = document.documentElement.scrollHeight - window.innerHeight;
        var progress = scrollableDist > 0 ? (scrollY / scrollableDist) : 0;
